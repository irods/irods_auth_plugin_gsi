...
def install_os_specific_dependencies_apt():
    irods_python_ci_utilities.install_os_packages(['globus-proxy-utils', 'libglobus-gssapi-gsi-dev', 'make', 'libssl-dev', 'libkrb5-dev', 'gcc'])
...
def install_os_specific_dependencies_yum():
    irods_python_ci_utilities.install_os_packages(['globus-proxy-utils', 'globus-gssapi-gsi-devel', 'openssl-devel', 'krb5-devel'])
